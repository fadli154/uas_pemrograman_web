...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (insertBook($_POST, $_FILES)) {
        ...
        $_SESSION["success"] = "Successfully added new book"; 
...
if (isset($_GET['delete_id'])) {
    $id = $_GET['delete_id'];
    deleteBook($id); // panggil fungsi hapus
    header("Location: books-index.php"); // redirect supaya URL bersih
    exit;
}
...
<head>
    ...
    <title>Books Index - Dashboard</title>
...
<body>
    ...
    <div id="app">
                ...
                <div class="page-heading">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                <p class="text-subtitle text-muted">
                                    Manage and view all registered books.
                                </p>
                            </div>
                    ...
                    <section class="section position-relative">
                        <button type="button" class="btn btn-success rounded-top-pill position-absolute"
                            data-bs-toggle="modal" data-bs-target="#modalAddBook" data-bs-toggle="tooltip"
                            data-bs-placement="top" data-bs-original-title="Add Book"
                                    ...
                                    <table class="table table-striped" id="bookTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-capitalize"><?= $book['publisher'] ?></td>
                                                <td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a href="book-edit.php?id=<?= $book['book_id'] ?>"
                                                                    class="dropdown-item position-relative btn-edit-book">
                                                                    <i
        ...
        <!-- modal tambah data -->
        <div class="modal fade text-left" id="modalAddBook" tabindex="-1" aria-labelledby="myModalLabel33"
            style="display: none;" aria-hidden="true" role="dialog" aria-modal="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header mx-2">
                        <h4 class="modal-title" id="myModalLabel33">Tambah Data Books</h4>
                                ...
                                <div class="col-12">
                                    <div class="form-group mandatory position-relative has-icon-left">
                                        ...
                                        <input type="text" id="book_id" name="book_id"
                                            ...
                                            placeholder="e.g BOOK002" value="<?= $_POST['book_id'] ?? '' ?>" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory position-relative has-icon-left">
                                        ...
                                        <input type="number" id="isbn" name="isbn"
                                            ...
                                            placeholder="e.g 9786027870413" value="<?= $_POST['isbn'] ?? '' ?>"
                                            required>
                                        <div class="form-control-icon" style="top: 38px">
