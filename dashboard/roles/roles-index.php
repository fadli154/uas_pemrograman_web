...
if (isset($_GET['delete_id'])) {
    $id = $_GET['delete_id'];
    deleteRole($id); // panggil fungsi hapus
    header("Location: roles-index.php"); // redirect supaya URL bersih
    exit;
}
...
<head>
    ...
    <title>Roles Index - Dashboard</title>
...
<body>
    ...
    <div id="app">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item active">
                            <a href="roles-index.php" class="sidebar-link">
                ...
                <div class="page-heading">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                <p class="text-subtitle text-muted">
                                    Manage and view all registered roles.
                                </p>
                            </div>
                    ...
                    <section class="section position-relative">
                        <button type="button" class="btn btn-success rounded-top-pill position-absolute"
                            data-bs-toggle="modal" data-bs-target="#modalAddRole" data-bs-toggle="tooltip"
                            data-bs-placement="top" data-bs-original-title="Add Role"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="rolesTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-capitalize"><?= $role['role_id'] ?></td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a href="role-detail.php?id=<?= $role['role_id'] ?>"
                                                                    class="dropdown-item position-relative btn-detail-role">
                                                                    <i class="bi bi-eye me-2 text-primary"></i>
                                                                    <span class="position-absolute text-primary"
                                                                        style="top: 9px">Detail</span>
                                                                </a>
                                                                <a href="role-edit.php?id=<?= $role['role_id'] ?>"
                                                                    class="dropdown-item position-relative btn-edit-role">
                                                                    <i
        ...
        <!-- modal tambah data -->
        <div class="modal fade text-left" id="modalAddRole" tabindex="-1" aria-labelledby="myModalLabel33"
            style="display: none;" aria-hidden="true" role="dialog" aria-modal="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header mx-2">
                        <h4 class="modal-title" id="myModalLabel33">Tambah Data Roles</h4>
                                ...
                                <div class="col-12">
                                    <div class="form-group mandatory position-relative has-icon-left">
                                        ...
                                        <input type="text" id="role_name" name="role_name"
                                            ...
                                            placeholder="e.g User" value="<?= $_POST['role_name'] ?? '' ?>" required>
