        ...
        <div class="container py-5">
            <div class="row g-3 align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    <h1 class="display-1 mb-0 animated slideInLeft">Profile</h1>
                </div>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <p class="mb-4">
                        <b class="me-3">Phone: </b> <?= $user['phone']; ?>
                    </p>
                    <p class="mb-4">
                        <b class="me-3">Email: </b> <?= $user['email']; ?>
                    </p>
                    <p class="mb-4">
                        <b class="me-3">Status: </b> <?= $user['status']; ?>
                    </p>
                </div>
            </div>
        </div>
